...
export const INITIAL_APPROVED_TOOLS: Tool[] = [
  {
    ...
    team: "Supply Ops",
    tags: ["listing-gap-detection", "viator", "inventory", "gcs-snapshots", "supply-ops"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: true,
  ...
  },
  {
    ...
    team: "Platform",
    tags: ["inventory-health", "oos-rates", "supplier-sla", "looker", "bigquery"],
    accessLevel: "request",
    sensitive: true,
    writeCapable: false,
  ...
  },
  {
    ...
    team: "Applied AI",
    tags: ["waf-rule-check", "tls-config", "cache-policy-audit", "security-baseline", "applied-ai"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    team: "Content",
    tags: ["content-qa", "brand-voice-check", "copyediting", "slack-bot", "google-docs-review"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    team: "Growth",
    tags: ["competitor-pricing", "ota-rate-comparison", "pricing-gap-analysis", "mcp-server", "growth"],
    accessLevel: "request",
    sensitive: false,
    writeCapable: false,
  ...
  },
  {
    ...
    owner: { name: "Alex Kim", slackId: "@alex.kim" },
    team: "Content",
    tags: ["ad-copy-scoring", "performance-marketing", "ab-test-suggestions", "channel-char-limits", "brand-guidelines"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Jordan Lee", slackId: "@jordan.lee" },
    team: "Platform",
    tags: ["guardian-sso", "google-workspace-auth", "nextjs-middleware", "session-management", "internal-tool-auth"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Tom Walsh", slackId: "@tom.w" },
    team: "Growth",
    tags: ["competitor-price-tracking", "ota-scraping", "price-gap-alerts", "bigquery", "growth"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Alex Kim", slackId: "@alex.kim" },
    team: "Growth",
    tags: ["seo-metadata", "meta-descriptions", "title-tag-generation", "pdp-copy", "claude-skill"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Maya Patel", slackId: "@maya.p" },
    team: "Supply Ops",
    tags: ["feed-sync-health", "supplier-integrations", "sync-latency", "stale-feed-detection", "grafana"],
    accessLevel: "request",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Jordan Lee", slackId: "@jordan.lee" },
    team: "Platform",
    tags: ["booking-failure-tracing", "checkout-debug", "payment-error-search", "webhook-replay", "zapdos"],
  ...
  },
  {
    ...
    team: "Applied AI",
    tags: ["zendesk-triage", "ticket-classification", "support-auto-routing", "first-response-drafts", "slack-bot"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Jordan Lee", slackId: "@jordan.lee" },
    team: "Platform",
    tags: ["replit-export", "railway-config-scaffold", "deploy-scaffold", "platform", "archived"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
  ...
  },
  {
    ...
    owner: { name: "Alex Kim", slackId: "@alex.kim" },
    team: "Content",
    tags: ["pdp-image-optimisation", "webp-conversion", "batch-image-cropping", "alt-text-suggestions", "figma-cms-plugin"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Maya Patel", slackId: "@maya.p" },
    team: "Supply Ops",
    tags: ["tour-copy-editing", "inclusions-meeting-points", "supply-cms-write", "replit-internal-app", "supply-ops"],
    accessLevel: "request",
    sensitive: false,
    writeCapable: true,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  {
    id: "engineering-golden-path",
    name: "Engineering golden path",
    oneLiner: "Canonical guide for shipping internal tools at Headout — stack, auth, and deploy.",
    description:
      "Living doc covering the default stack (Next.js, Railway, Guardian auth), when to escalate to Platform, and how to register what you ship back to the AI Storefront. Required reading before starting a new internal app.",
    types: ["docs"],
    link: "https://notion.headout.internal/engineering/golden-path",
    owner: { name: "Jordan Lee", slackId: "@jordan.lee" },
    team: "Platform",
    tags: ["internal-tool-shipping", "golden-path", "guardian", "railway", "platform"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Open access for all engineers. Suggest edits in #platform — Jordan owns the canonical version.",
    status: "live",
    approvalStatus: "approved",
    submittedBy: "jordan-lee",
    usageStats: { views: 612, clicks: 284, helpful: 67 },
    lastUpdated: "2026-06-12T09:00:00Z",
    lastUsed: "2026-06-23T08:00:00Z",
    ownerConfirmed: true,
  },
  {
    id: "ai-storefront-contributor-guide",
    name: "AI Storefront contributor guide",
    oneLiner: "How to register tools, write good one-liners, and keep catalogue entries fresh.",
    description:
      "Step-by-step doc for submitting live tools vs planned ideas, picking the right type tags, writing owner instructions, and handling access levels. Includes examples of strong vs weak listings.",
    types: ["docs"],
    link: "https://notion.headout.internal/ai-storefront/contributor-guide",
    owner: { name: "Alex Kim", slackId: "@alex.kim" },
    team: "Applied AI",
    tags: ["tool-registration", "catalogue-listing", "one-liner-writing", "access-levels", "applied-ai"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Start here before registering a tool. Questions go to #project-ai-internal-storefront.",
    status: "live",
    approvalStatus: "approved",
    submittedBy: "alex-kim",
    usageStats: { views: 445, clicks: 198, helpful: 54 },
    lastUpdated: "2026-06-19T14:00:00Z",
    lastUsed: "2026-06-22T16:30:00Z",
    ownerConfirmed: true,
  },
  {
    id: "bigquery-access-runbook",
    name: "BigQuery access runbook",
    oneLiner: "Request, provision, and troubleshoot BigQuery and Looker access at Headout.",
    description:
      "Runbook for data access: which Slack channels to use, typical turnaround, sensitive dataset rules, and links to dbt model ownership. Covers read-only vs write roles and when Platform must sign off.",
    types: ["docs"],
    link: "https://notion.headout.internal/data/bigquery-access",
    owner: { name: "Jordan Lee", slackId: "@jordan.lee" },
    team: "Platform",
    tags: ["bigquery-access", "looker-access", "dataset-permissions", "dbt-ownership", "platform"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Follow the runbook before pinging #data-platform. Jordan handles exceptions.",
    status: "live",
    approvalStatus: "approved",
    submittedBy: "jordan-lee",
    usageStats: { views: 389, clicks: 167, helpful: 38 },
    lastUpdated: "2026-06-08T11:00:00Z",
    lastUsed: "2026-06-20T10:15:00Z",
    ownerConfirmed: true,
  },
  {
    id: "mcp-registration-howto",
    name: "MCP registration how-to",
    oneLiner: "Checklist for publishing an internal MCP server to the catalogue.",
    description:
      "Covers naming conventions, required README sections, auth patterns, staging vs production endpoints, and the admin approval bar for write-capable MCPs. Links to the booking-debug MCP as a reference implementation.",
    types: ["docs"],
    link: "https://notion.headout.internal/applied-ai/mcp-registration",
    owner: { name: "Priya Sharma", slackId: "@priya.s" },
    team: "Applied AI",
    tags: ["mcp-registration", "mcp-auth-patterns", "staging-endpoints", "catalogue-approval", "applied-ai"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Read before submitting an MCP. Pair with the contributor guide for listing copy.",
    status: "beta",
    approvalStatus: "approved",
    submittedBy: "priya-sharma",
    usageStats: { views: 203, clicks: 91, helpful: 22 },
    lastUpdated: "2026-06-17T09:30:00Z",
    lastUsed: "2026-06-21T13:00:00Z",
    ownerConfirmed: true,
  },
];
...
export const KITS: Kit[] = [
  {
    id: "essentials",
    name: "Essentials",
    description: "Cross-team staples everyone reaches for — auth, QA, dashboards, docs, and support.",
    toolIds: [
      ...
      "ai-storefront-contributor-guide",
    ],
  ...
  },
  {
    ...
    toolIds: [
      ...
      "guardian-auth-plugin",
      "bq-availability-dashboard",
      "mcp-registration-howto",
      "bigquery-access-runbook",
    ],
...
export const INITIAL_PENDING_TOOLS: Tool[] = [
  {
    ...
    owner: { name: "Priya Sharma", slackId: "@priya.s" },
    team: "Applied AI",
    tags: ["llm-routing", "model-allowlist", "spend-caps", "prompt-audit-logging", "shared-ai-infra"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
...

  {
    ...
    owner: { name: "Maya Patel", slackId: "@maya.p" },
    team: "Supply Ops",
    tags: ["gttd-feed-validation", "google-things-to-do", "feed-xml-linting", "geo-price-checks", "supply-ops"],
    accessLevel: "open",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Priya Sharma", slackId: "@priya.s" },
    team: "Applied AI",
    tags: ["agent-memory", "context-persistence", "session-resume", "multi-step-workflows", "claude-agent-plugin"],
    accessLevel: "request",
    sensitive: true,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
  ...
  },
  {
    ...
    owner: { name: "Tom Walsh", slackId: "@tom.w" },
    team: "Growth",
    tags: ["conversion-funnel", "checkout-drop-off", "funnel-regression", "looker-dashboard", "segment-events"],
    accessLevel: "request",
    sensitive: false,
    writeCapable: false,
    ownerInstructions: "Ping the owner on Slack — include your use case.",
